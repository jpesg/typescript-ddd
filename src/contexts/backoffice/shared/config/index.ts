...
if (backofficeConfig.env === 'test') {
  backofficeConfig.mongo.database = backofficeConfig.mongo.database + '-test'
  backofficeConfig.typeOrm.database = backofficeConfig.typeOrm.database + '-test'
}
